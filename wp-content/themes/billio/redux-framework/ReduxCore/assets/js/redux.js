...
/**
	...
	**/
	...
	jQuery('#redux-import').click(function(e) {
		if (jQuery('#import-code-value').val() === "" && jQuery('#import-link-value').val() === "" && jQuery('#import-file-value').val()==="") {
			e.preventDefault();
			return false;
		}
	});
	...
	jQuery('#redux-import-code-button').click(function() {
		...
		if (jQuery('#redux-import-file-wrapper').is(':visible')) {
			jQuery('#redux-import-file-wrapper').fadeOut('fast');
			jQuery('#import-file-value').val('');
		}
	...
	jQuery('#redux-import-file-button').click(function() {
		if (jQuery('#redux-import-code-wrapper').is(':visible')) {
			jQuery('#redux-import-code-wrapper').fadeOut('fast');
			jQuery('#import-code-value').val('');
		}
		...
		jQuery('#redux-import-file-wrapper').fadeIn('slow');
	});
