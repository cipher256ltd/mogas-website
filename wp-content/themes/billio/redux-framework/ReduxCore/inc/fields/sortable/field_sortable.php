<?php
class DethemeReduxFramework_sortable extends DethemeReduxFramework {
    ...
    */
    ...
    function enqueue() {
        ...
        wp_enqueue_style(
            ...
            DethemeReduxFramework::$_url.'inc/fields/sortable/field_sortable.css', 
            time(),
            true
        );  
        ...
        wp_enqueue_script(
            ...
            DethemeReduxFramework::$_url . 'inc/fields/sortable/field_sortable.js', 
            array('jquery'),
            time(),
            true
        );        
