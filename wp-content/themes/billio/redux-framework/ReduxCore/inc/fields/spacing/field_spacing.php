<?php
class DethemeReduxFramework_spacing extends DethemeReduxFramework{	
	...
	*/
	function enqueue(){
		...
		wp_enqueue_script(
			...
			DethemeReduxFramework::$_url.'inc/fields/spacing/field_spacing.js', 
		...
		wp_enqueue_style(
			...
			DethemeReduxFramework::$_url.'inc/fields/spacing/field_spacing.css', 
			time(),
			true
		);	
