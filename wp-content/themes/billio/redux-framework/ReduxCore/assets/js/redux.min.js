...
(function($){
    "use strict";
    $.redux.multi_career_text = $.group || {};
    $(document).ready(function () {
        $.redux.multi_career_text();
    });

    $.redux.multi_career_text = function(){
		$('.redux-career-multi-text-remove').live('click', function() {
			redux_change($(this));
		...
		$('.redux-career-multi-text-add').click(function(){
			var number = parseInt($(this).attr('data-add_number'));
			var id = $(this).attr('data-id');
			var name = $(this).attr('data-name');
			var oldnum=$('#'+id+' li').length * 2;
			...
			for (var i = 0; i < number; i++) {
				...
				$('#'+id+' li:last-child .regular-text').val('');
				$('#'+id+' li:last-child .icon-field').val('');
				$('#'+id+' li:last-child .regular-text').attr('name' , name+'['+(i+oldnum)+'][label]');
				$('#'+id+' li:last-child .icon-field').attr('name' , name+'['+(i+oldnum)+'][icon]');
			}
		});
    };
})(jQuery);